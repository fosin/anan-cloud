...
public class VersionController implements ISimpleController<VersionRespDto,
    ...
    public ResponseEntity<List<PermissionRespDto>> getListChild(@PathVariable Long pid, @RequestParam Long versionId) {
    ...
    public ResponseEntity<List<VersionPermissionRespDto>> permissions(@PathVariable Long versionId) {
    ...
    public ResponseEntity<Boolean> permissions(@RequestBody List<VersionPermissionReqDto> dtos,
