...
@Schema(description = "系统通用字典明细表(anan_dictionary_detail)更新DTO")
public class DictionaryDetailUpdateDTO extends Id<Long> implements ForeignKeyProp<Long> {
    ...
    @NotNull(message = "字典序号" + "{jakarta.validation.constraints.NotNull.message}", groups = Update.class)
    @Schema(description = "字典序号，取值于字典表anan_dictionary.id", example = "Long")
    private Long dictionaryId;

    @NotNull(message = "字典明细键" + "{jakarta.validation.constraints.NotNull.message}", groups = Update.class)
    ...
    @NotNull(message = "顺序" + "{jakarta.validation.constraints.NotNull.message}", groups = Update.class)
    ...
    @NotNull(message = "使用标志" + "{jakarta.validation.constraints.NotNull.message}", groups = Update.class)
