package top.fosin.anan.platform.modules.oauth2client.dto;
...
public class Oauth2RegisteredClientCreateDTO extends LogiSortQuery<LogiQueryRule, SortRule, String> {
