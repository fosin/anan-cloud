...
public class DictionaryCreateDTO {
    ...
    @NotBlank(message = "字典名称" + "{javax.validation.constraints.NotBlank.message}", groups = Create.class)
    ...
    @NotNull(message = "字典类别" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
    @Positive(message = "字典类别" + "{javax.validation.constraints.Positive.message}", groups = Create.class)
