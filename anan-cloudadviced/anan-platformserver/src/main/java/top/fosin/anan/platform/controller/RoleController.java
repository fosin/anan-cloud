...
public class RoleController implements ISimpleController<AnanRoleRespDto, Long,
    ...
    public ResponseEntity<Collection<AnanRolePermissionRespDto>> permissions(@RequestBody List<AnanRolePermissionCreateDto> entities,
    ...
    public ResponseEntity<List<AnanUserRespDto>> getRoleUsers(@PathVariable("roleId") Long roleId) {
    ...
    public ResponseEntity<Boolean> putRoleUsers(@RequestBody List<AnanUserRoleCreateDto> dtos,
                                                @PathVariable("roleId") Long roleId) {
    ...
    public ResponseEntity<List<AnanUserRespDto>> getOtherUsers(@PathVariable("roleId") Long roleId) throws AnanControllerException {
    ...
    @ApiImplicitParam(name = "organizId", value = "机构ID",
            required = true, dataTypeClass = Long.class, paramType = "path")
    public ResponseEntity<List<AnanRoleRespDto>> findAllByOrganizId(@PathVariable("organizId") Long organizId) {
