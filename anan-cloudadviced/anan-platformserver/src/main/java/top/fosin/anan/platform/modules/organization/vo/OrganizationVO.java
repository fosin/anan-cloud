...
@ApiModel(value = "系统机构表单体VO", description = "系统机构表(anan_organization)单体VO")
public class OrganizationVO extends IdPid<Long> {
    private static final long serialVersionUID = 909621691487974665L;
