...
public class VersionUpdateDTO extends Id<Long> {
    ...
    @NotBlank(message = "版本名称" + "{javax.validation.constraints.NotBlank.message}", groups = Update.class)
    @ApiModelProperty(value = "版本名称", required = true)
    private String name;

    @NotNull(message = "版本类型" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    @PositiveOrZero(message = "版本类型" + "{javax.validation.constraints.Positive.message}", groups = Update.class)
    @ApiModelProperty(value = "版本类型：0=收费版 1=免费版 2=开发版", required = true)
    private Byte type;

    @NotNull(message = "版本价格" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    ...
    @PositiveOrZero(message = "到期后保护期" + "{javax.validation.constraints.Positive.message}", groups = Update.class)
    ...
    @PositiveOrZero(message = "最大机构数" + "{javax.validation.constraints.Positive.message}", groups = Update.class)
    @ApiModelProperty(value = "最大机构数：0=无限制 n=限制数", required = true)
    private Integer maxOrganizs;

    @NotNull(message = "最大用户数" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    @PositiveOrZero(message = "最大用户数" + "{javax.validation.constraints.Positive.message}", groups = Update.class)
    ...
    @NotNull(message = "启用状态" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    @PositiveOrZero(message = "启用状态" + "{javax.validation.constraints.Positive.message}", groups = Update.class)
