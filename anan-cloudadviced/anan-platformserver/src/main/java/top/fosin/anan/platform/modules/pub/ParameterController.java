...
public class ParameterController implements ISimpleController<ParameterRespDto, Long,
    ...
    public ResponseEntity<ParameterRespDto> getNearestParameter(@PositiveOrZero @RequestParam("type") Integer type,
    ...
    public ResponseEntity<ParameterRespDto> getParameter(@PositiveOrZero @RequestParam("type") Integer type,
                                                         @RequestParam("scope") String scope,
                                                         @NotBlank @RequestParam("name") String name) {
    ...
    public ResponseEntity<String> getOrCreateParameter(@RequestBody ParameterReqDto retrieveDto) {
    ...
    public ResponseEntity<Boolean> applyChange(@Positive @PathVariable(TreeDto.ID_NAME) Long id) {
