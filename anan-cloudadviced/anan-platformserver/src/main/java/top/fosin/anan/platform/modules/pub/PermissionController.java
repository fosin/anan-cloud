...
public class PermissionController extends BaseController
    ...
    public ResponseEntity<List<PermissionRespDto>> findByServiceCode(@NotBlank @PathVariable String serviceCode) {
    ...
    public ResponseEntity<List<PermissionRespDto>> findByServiceCodes(@NotEmpty @RequestBody List<String> serviceCodes) {
