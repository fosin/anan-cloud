...
@Data
@ApiModel(value = "系统机构授权表查询DTO", description = "系统机构授权的查询DTO")
public class AnanOrganizationAuthRetrieveDto extends QuerySortRuleDto<LogicalQueryRule, SortRule> implements Serializable {
