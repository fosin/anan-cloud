...
@ApiModel(value = "系统通用字典明细表创建DTO", description = "系统通用字典明细表(anan_dictionary_detail)创建DTO")
public class DictionaryDetailCreateDTO {
    private static final long serialVersionUID = -46164990948316096L;
    
    @NotNull(message = "字典序号" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
    @ApiModelProperty(value = "字典序号，取值于字典表anan_dictionary.id", required = true, example = "Long")
    private Long dictionaryId;

    @NotNull(message = "字典明细键" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
    ...
    @NotNull(message = "顺序" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
    ...
    @NotNull(message = "使用标志" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
