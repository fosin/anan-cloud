...
@ApiModel(value = "系统支付订单表单体VO", description = "系统支付订单表(anan_pay_order)单体VO")
public class PayOrderVO extends Id<Long> {
    private static final long serialVersionUID = -93791012114212324L;
