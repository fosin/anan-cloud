...
public interface IParameter {
     ...
     * @return 参数数据
     */
    default AnanParameterEntity setParameter(String name, String value, String description) {
     ...
     * @return 参数数据
     */
    AnanParameterEntity setParameter(String scope, String name, String value, String description);
