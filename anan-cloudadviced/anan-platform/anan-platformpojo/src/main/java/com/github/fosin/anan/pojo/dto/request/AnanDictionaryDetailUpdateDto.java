...
public class AnanDictionaryDetailUpdateDto implements Serializable {
    ...
    @ApiModelProperty(value = "字典ID，取值于字典明细表AnanDictionaryEntity.id", example = "Long", required = true)
