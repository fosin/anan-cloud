 ...
 */
@Data
@ApiModel(value = "用于存放各种分类分组的个性化参数更新DTO", description = "表(anan_parameter)的对应的更新DTO")
public class AnanParameterUpdateDto implements Serializable {
    ...
    @ApiModelProperty(value = "参数分类：具体取值于字典表anan_dictionary.code=10", example = "Integer", required = true)
