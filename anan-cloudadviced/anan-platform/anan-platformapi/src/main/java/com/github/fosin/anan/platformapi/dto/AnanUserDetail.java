...
public class AnanUserDetail extends User {
    @Getter
    private AnanUserEntity user;
    @Getter
    private AnanPermissionEntity permissionTree;
    @Getter
    ...
    public AnanUserDetail(AnanUserEntity user, AnanPermissionEntity permissionTree, Collection<? extends GrantedAuthority> authorities) {
