...
public class AnanUserRegisterDto implements Serializable {
    ...
    @ApiModelProperty(value = "使用状态：具体取值于字典表anan_dictionary.id=15", example = "Integer", required = true)
    private Integer sex;
    ...
    @NotNull(message = "使用状态" + "{javax.validation.constraints.NotNull.message}")
    @ApiModelProperty(value = "使用状态：0=启用，1=禁用，具体取值于字典表anan_dictionary.id=11", example = "Integer", required = true)
