...
@Schema(description = "OAUTH2认证客户端注册表(oauth2_registered_client)更新DTO")
public class Oauth2RegisteredClientUpdateDTO extends Id<String> {
    ...
    @NotBlank(message = "客户端序号" + "{jakarta.validation.constraints.NotBlank.message}", groups = Update.class)
    ...
    @NotBlank(message = "客户端名称" + "{jakarta.validation.constraints.NotBlank.message}", groups = Update.class)
