...
public class UserUpdateDTO extends Id<Long> {
    ...
    @NotBlank(message = "用户工号" + "{javax.validation.constraints.NotBlank.message}", groups = Update.class)
    ...
    @NotBlank(message = "用户姓名" + "{javax.validation.constraints.NotBlank.message}", groups = Update.class)
    ...
    @Past(message = "生日" + "{javax.validation.constraints.Past.message}", groups = Update.class)
    @NotNull(message = "生日" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    private Date birthday;

    @NotNull(message = "使用状态：具体取值于字典表anan_dictionary.code=15" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    ...
    @Pattern(regexp = RegexUtil.PHONE_ZH_CN, message = "手机号码{javax.validation.constraints.Pattern.message}", groups = Create.class)
    private String phone;

    @NotNull(message = "使用状态：0=启用，1=禁用，具体取值于字典表anan_dictionary.code=11" + "{javax.validation.constraints.NotNull.message}", groups = Update.class)
    ...
    @NotNull(message = "过期时间" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
