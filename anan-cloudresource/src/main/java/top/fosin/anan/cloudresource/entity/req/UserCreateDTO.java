...
public class UserCreateDTO {
    ...
    @NotBlank(message = "用户工号" + "{javax.validation.constraints.NotBlank.message}", groups = Create.class)
    ...
    @NotBlank(message = "用户姓名" + "{javax.validation.constraints.NotBlank.message}", groups = Create.class)
    ...
    @NotBlank(message = "传入原始密码，后台会对原始密码进行加密后再存储" + "{javax.validation.constraints.NotBlank.message}", groups = Create.class)
    ...
    @NotNull(message = "使用状态：具体取值于字典表anan_dictionary.code=15" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
    ...
    @NotNull(message = "使用状态：0=启用，1=禁用，具体取值于字典表anan_dictionary.code=11" + "{javax.validation.constraints.NotNull.message}", groups = Create.class)
