...
public class CdpSysDictionaryDetailEntity extends AbstractSoftDeleteJpaEntity<Long, Long> implements Serializable {
    ...
    @Basic
    @ApiModelProperty(value = "取值于字典明细表cdp_sys_dictionary.id", required = true)
