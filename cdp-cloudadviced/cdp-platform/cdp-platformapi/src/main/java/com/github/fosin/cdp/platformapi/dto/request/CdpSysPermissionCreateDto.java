...
/**
 * 包含菜单、按钮两种权限(CdpSysPermission)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "包含菜单、按钮两种权限创建DTO", description = "表(cdp_sys_permission)的对应的创建DTO")
public class CdpSysPermissionCreateDto implements Serializable {
    private static final long serialVersionUID = -20543011885202742L;
