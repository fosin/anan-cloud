...
/**
 * 系统机构表(CdpSysOrganization)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统机构表创建DTO", description = "表(cdp_sys_organization)的对应的创建DTO")
public class CdpSysOrganizationCreateDto implements Serializable {
    private static final long serialVersionUID = -52765323274198168L;
