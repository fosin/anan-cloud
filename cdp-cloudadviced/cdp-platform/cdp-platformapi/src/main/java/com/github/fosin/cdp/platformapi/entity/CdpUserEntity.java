...
@DynamicUpdate
@Table(name = "cdp_user")
@ApiModel(value = "系统用户表实体类", description = "表(cdp_user)的对应的实体类")
public class CdpUserEntity extends AbstractOrganizIdJpaEntity<Long, Long> implements Serializable {
    ...
    private List<CdpUserRoleEntity> userRoles;
    ...
    @Basic
    @ApiModelProperty(value = "使用状态：具体取值于字典表cdp_dictionary.id=15", required = true)
