...
/**
 * 系统通用字典表(CdpSysDictionary)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统通用字典表创建DTO", description = "表(cdp_sys_dictionary)的对应的创建DTO")
public class CdpSysDictionaryCreateDto implements Serializable {
    private static final long serialVersionUID = 150097462349326387L;
