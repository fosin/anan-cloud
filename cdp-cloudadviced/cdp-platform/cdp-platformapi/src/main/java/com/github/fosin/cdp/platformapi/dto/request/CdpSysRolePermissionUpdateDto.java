...
/**
 * 系统角色权限表(CdpSysRolePermission)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统角色权限表更新DTO", description = "表(cdp_sys_role_permission)的对应的更新DTO")
public class CdpSysRolePermissionUpdateDto implements Serializable {
