 ...
 * @author fosin
 */
public interface IRolePermissionService extends ICrudBatchJpaService<CdpSysRolePermissionEntity, Long, Long, CdpSysRolePermissionEntity, CdpSysRolePermissionEntity, CdpSysRolePermissionEntity> {
