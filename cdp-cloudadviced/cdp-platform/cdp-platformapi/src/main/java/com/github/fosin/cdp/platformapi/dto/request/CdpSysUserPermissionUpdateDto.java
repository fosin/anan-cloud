...
/**
 * 用于增减用户的单项权限，通常实在角色的基础上增减单项权限(CdpSysUserPermission)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "用于增减用户的单项权限，通常实在角色的基础上增减单项权限更新DTO", description = "表(cdp_sys_user_permission)的对应的更新DTO")
public class CdpSysUserPermissionUpdateDto implements Serializable {
