...
/**
 * 用于存放各种分类分组的个性化参数(CdpSysParameter)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "用于存放各种分类分组的个性化参数更新DTO", description = "表(cdp_sys_parameter)的对应的更新DTO")
public class CdpSysParameterUpdateDto implements Serializable {
    private static final long serialVersionUID = 251693152428787983L;
    
    @NotNull
    @ApiModelProperty(value = "参数ID", example = "Long", required = true)
    private Long id;
