 ...
 */
@Data
@ApiModel(value = "系统用户表查询DTO", description = "表(cdp_user)的对应的查询DTO")
public class CdpUserRetrieveDto implements Serializable {
    ...
    @NotNull
    @ApiModelProperty(value = "使用状态：具体取值于字典表cdp_dictionary.id=15", example = "Integer")
    private Integer sex;
    ...
    @NotNull
    @ApiModelProperty(value = "使用状态：0=启用，1=禁用，具体取值于字典表cdp_dictionary.id=11", example = "Integer")
