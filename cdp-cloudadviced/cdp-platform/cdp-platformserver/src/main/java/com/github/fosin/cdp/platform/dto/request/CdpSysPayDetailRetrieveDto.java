 ...
 */
@Data
@ApiModel(value = "系统支付明细表查询DTO", description = "表(cdp_sys_pay_detail)的对应的查询DTO")
public class CdpSysPayDetailRetrieveDto implements Serializable {
