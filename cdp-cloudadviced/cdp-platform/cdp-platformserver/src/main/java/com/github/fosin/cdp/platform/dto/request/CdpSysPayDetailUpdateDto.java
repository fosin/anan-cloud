 ...
 */
@Data
@ApiModel(value = "系统支付明细表更新DTO", description = "表(cdp_sys_pay_detail)的对应的更新DTO")
public class CdpSysPayDetailUpdateDto implements Serializable {
