...
/**
 * 系统支付发票表(CdpSysPayInvoice)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统支付发票表更新DTO", description = "表(cdp_sys_pay_invoice)的对应的更新DTO")
public class CdpSysPayInvoiceUpdateDto implements Serializable {
