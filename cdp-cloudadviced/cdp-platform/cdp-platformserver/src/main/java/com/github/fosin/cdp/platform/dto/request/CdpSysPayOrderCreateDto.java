 ...
 */
@Data
@ApiModel(value = "系统支付订单表创建DTO", description = "表(cdp_sys_pay_order)的对应的创建DTO")
public class CdpSysPayOrderCreateDto implements Serializable {
