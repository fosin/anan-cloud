...
/**
 * 系统版本角色表(CdpSysVersionRole)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统版本角色表更新DTO", description = "表(cdp_sys_version_role)的对应的更新DTO")
public class CdpSysVersionRoleUpdateDto implements Serializable {
