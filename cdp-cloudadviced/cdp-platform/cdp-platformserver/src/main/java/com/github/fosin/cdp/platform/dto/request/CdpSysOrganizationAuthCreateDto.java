...
/**
 * 系统机构授权表(CdpSysOrganizationAuth)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统机构授权表创建DTO", description = "表(cdp_sys_organization_auth)的对应的创建DTO")
public class CdpSysOrganizationAuthCreateDto implements Serializable {
    private static final long serialVersionUID = 369660007685839015L;
