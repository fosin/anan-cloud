...
public class CdpSysPayController implements ISimpleController<CdpSysPayEntity, Long, CdpSysPayEntity, CdpSysPayEntity> {
    /**
     * 服务对象
     */
    @Autowired
    ...
    @Override
    public ISimpleService<CdpSysPayEntity, Long, CdpSysPayEntity, CdpSysPayEntity> getService() {
