...
/**
 * 系统机构授权表(CdpSysOrganizationAuth)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统机构授权表更新DTO", description = "表(cdp_sys_organization_auth)的对应的更新DTO")
public class CdpSysOrganizationAuthUpdateDto implements Serializable {
