 ...
 */
@Data
@ApiModel(value = "系统版本表更新DTO", description = "表(cdp_sys_version)的对应的更新DTO")
public class CdpSysVersionUpdateDto implements Serializable {
    private static final long serialVersionUID = 916612088377560599L;
