...
/**
 * 系统版本权限表(CdpSysVersionPermission)更新DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统版本权限表更新DTO", description = "表(cdp_sys_version_permission)的对应的更新DTO")
public class CdpSysVersionPermissionUpdateDto implements Serializable {
