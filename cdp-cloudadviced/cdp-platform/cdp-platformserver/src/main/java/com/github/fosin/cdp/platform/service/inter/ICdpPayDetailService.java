 ...
 */
public interface ICdpPayDetailService extends ISimpleJpaService<CdpPayDetailEntity, Long, CdpPayDetailCreateDto, CdpPayDetailRetrieveDto, CdpPayDetailUpdateDto> {
}
