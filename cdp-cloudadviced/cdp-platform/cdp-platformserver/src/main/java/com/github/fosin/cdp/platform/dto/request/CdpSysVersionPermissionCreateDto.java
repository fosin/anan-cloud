...
/**
 * 系统版本权限表(CdpSysVersionPermission)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统版本权限表创建DTO", description = "表(cdp_sys_version_permission)的对应的创建DTO")
public class CdpSysVersionPermissionCreateDto implements Serializable {
