...
public class CdpSysPayDetailController implements ISimpleController<CdpSysPayDetailEntity, Long, CdpSysPayDetailEntity, CdpSysPayDetailEntity, CdpSysPayDetailEntity> {
    /**
     * 服务对象
     */
    @Autowired
    ...
    @Override
    public ISimpleService<CdpSysPayDetailEntity, Long, CdpSysPayDetailEntity, CdpSysPayDetailEntity, CdpSysPayDetailEntity> getService() {
