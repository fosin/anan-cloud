...
/**
 * 系统版本角色权限表(CdpSysVersionRolePermission)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统版本角色权限表创建DTO", description = "表(cdp_sys_version_role_permission)的对应的创建DTO")
public class CdpSysVersionRolePermissionCreateDto implements Serializable {
