 ...
 */
public interface ICdpPayOrderService extends ISimpleJpaService<CdpPayOrderEntity, Long, CdpPayOrderCreateDto, CdpPayOrderRetrieveDto, CdpPayOrderUpdateDto> {
}
