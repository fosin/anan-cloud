...
@DynamicUpdate
@Table(name = "cdp_version_role")
@ApiModel(value = "系统版本角色表实体类", description = "表(cdp_version_role)的对应的实体类")
public class CdpVersionRoleEntity extends AbstractCreateUpdateJpaEntity<Long, Long> implements Serializable {
