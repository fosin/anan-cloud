...
import com.github.fosin.cdp.platform.dto.request.CdpSysPayOrderRetrieveDto;
import com.github.fosin.cdp.platform.dto.request.CdpSysPayOrderUpdateDto;
...
public class CdpSysPayOrderController implements ISimpleController<CdpSysPayOrderEntity, Long, CdpSysPayOrderCreateDto, CdpSysPayOrderRetrieveDto, CdpSysPayOrderUpdateDto> {
    /**
     * 服务对象
     */
    @Autowired
    ...
    @Override
    public ISimpleService<CdpSysPayOrderEntity, Long, CdpSysPayOrderCreateDto, CdpSysPayOrderRetrieveDto, CdpSysPayOrderUpdateDto> getService() {
