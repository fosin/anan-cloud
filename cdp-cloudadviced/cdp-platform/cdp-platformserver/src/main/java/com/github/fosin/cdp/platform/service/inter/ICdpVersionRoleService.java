 ...
 */
public interface ICdpVersionRoleService extends ISimpleJpaService<CdpVersionRoleEntity, Long, CdpVersionRoleCreateDto, CdpVersionRoleRetrieveDto, CdpVersionRoleUpdateDto> {
}
