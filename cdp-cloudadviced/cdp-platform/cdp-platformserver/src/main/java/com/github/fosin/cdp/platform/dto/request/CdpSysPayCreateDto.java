 ...
 */
@Data
@ApiModel(value = "系统支付表创建DTO", description = "表(cdp_sys_pay)的对应的创建DTO")
public class CdpSysPayCreateDto implements Serializable {
    private static final long serialVersionUID = -29370039799011041L;
