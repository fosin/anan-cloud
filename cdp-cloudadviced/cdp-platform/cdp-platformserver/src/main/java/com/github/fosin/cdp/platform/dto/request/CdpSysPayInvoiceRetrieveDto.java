...
/**
 * 系统支付发票表(CdpSysPayInvoice)查询DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统支付发票表查询DTO", description = "表(cdp_sys_pay_invoice)的对应的查询DTO")
public class CdpSysPayInvoiceRetrieveDto implements Serializable {
