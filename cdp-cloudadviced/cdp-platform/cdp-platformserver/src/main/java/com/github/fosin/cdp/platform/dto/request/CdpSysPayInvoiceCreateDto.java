...
/**
 * 系统支付发票表(CdpSysPayInvoice)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统支付发票表创建DTO", description = "表(cdp_sys_pay_invoice)的对应的创建DTO")
public class CdpSysPayInvoiceCreateDto implements Serializable {
