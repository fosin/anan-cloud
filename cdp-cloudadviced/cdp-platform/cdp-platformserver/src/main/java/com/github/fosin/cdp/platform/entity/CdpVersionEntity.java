...
@ApiModel(value = "系统版本表实体类", description = "表(cdp_version)的对应的实体类")
public class CdpVersionEntity extends AbstractCreateUpdateJpaEntity<Long, Long> implements Serializable {
