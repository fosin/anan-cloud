...
/**
 * 系统机构权限表(CdpSysOrganizationPermission)创建DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统机构权限表创建DTO", description = "表(cdp_sys_organization_permission)的对应的创建DTO")
public class CdpSysOrganizationPermissionCreateDto implements Serializable {
