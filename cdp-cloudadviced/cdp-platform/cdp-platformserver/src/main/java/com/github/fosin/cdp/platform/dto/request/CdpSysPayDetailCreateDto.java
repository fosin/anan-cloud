 ...
 */
@Data
@ApiModel(value = "系统支付明细表创建DTO", description = "表(cdp_sys_pay_detail)的对应的创建DTO")
public class CdpSysPayDetailCreateDto implements Serializable {
