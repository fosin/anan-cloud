...
/**
 * 系统机构权限表(CdpSysOrganizationPermission)查询DTO
 *
 * @author fosin
 ...
 */
@Data
@ApiModel(value = "系统机构权限表查询DTO", description = "表(cdp_sys_organization_permission)的对应的查询DTO")
public class CdpSysOrganizationPermissionRetrieveDto implements Serializable {
