 ...
 */
@Slf4j
public class CdpTokenServices extends DefaultTokenServices {
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        if (existingAccessToken != null) {
            ...
            if (userAuthentication != null) {
                CdpUserDetail principal = (CdpUserDetail) userAuthentication.getPrincipal();
                if (principal != null) {
                    String oldClientIp = "";
                    ...
                    if (oldAuthentication != null) {
                        ...
                        //由于直接通过(CdpUserDetail) userAuthentication.getPrincipal()获取oldPrincipal会和springboot-devtools
...
//                   oldClientIp = client.getIp();
                        CdpUserDetail oldPrincipal = (CdpUserDetail) oldUserAuthentication.getPrincipal();
